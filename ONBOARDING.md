...
실무 개발을 시작하려면 다음 명령어를 입력하세요:

> **"00-team-architect 진행해. Phase 1 시작하자."**

또는 특정 전문가에게 직접 요청할 수 있습니다:
- "UI 개발 시작해줘" (01-frontend-expert 호출)
- "데이터 로직 구현해줘" (02-logic-specialist 호출)
